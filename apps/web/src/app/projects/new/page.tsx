...
function NewProjectPage() {
  ...
  const [lotteryWasExtracted, setLotteryWasExtracted] = useState(false);
  ...
  function continueFromMessage() {
    ...
    if (lottery) {
      ...
      setLotteryWasExtracted(true);
    } else {
      setLotteryWasExtracted(false);
    }
    setStep("details");
  }
  ...
  async function create() {
    ...
    const identifiers = [
      form.lottery && { type: "lottery-number", value: form.lottery, origin: lotteryWasExtracted ? "winning-message" : "manual" },
